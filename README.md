...
ok so picture this: someone looked at Tetris. a game that already exists, works fine, brings joy to millions. and what if that someone, looking at Tetris said "what if it was one function. what if the whole thing was one lambda. what if `__import__` showed up six times and that felt *normal*." that someone was me. this is that thing.
